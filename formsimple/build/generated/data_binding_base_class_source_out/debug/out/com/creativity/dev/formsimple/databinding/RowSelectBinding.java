...
public final class RowSelectBinding implements ViewBinding {
  ...
  private RowSelectBinding(@NonNull LinearLayout rootView, @NonNull ImageView icon,
      @NonNull ImageView imgCheck, @NonNull LinearLayout lnyContent, @NonNull TextView tvTitle) {
  ...
  public static RowSelectBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RowSelectBinding((LinearLayout) rootView, icon, imgCheck, lnyContent, tvTitle);
    }
